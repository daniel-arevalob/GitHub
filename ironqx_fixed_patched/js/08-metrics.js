...
function renderAdmAdhHist(pid){
  ...
  // FIX Bug40: normalizar valores de adh por si vienen como objetos tras sync Supabase
  const _nah=v=>{if(!v)return"none";if(typeof v==="string")return v;if(typeof v==="object")return v.notes||"none";return"none";};
  ...
  for(let w=0;w<8;w++){
    ...
    for(let d=0;d<7;d++){
      ...
      days.push({k,st:_nah(adh[k]||"none")});
    }
